        ...
        <div className="flex items-center justify-center h-screen bg-gradient-to-br from-gray-900 to-gray-800">
            <div className="w-full max-w-lg p-8 space-y-8 bg-gray-800/50 border border-gray-700 rounded-2xl shadow-2xl">
                <div className="text-left">
                    ...
                    <p className="mt-2 text-gray-400">Reset password and optionally change role for the selected user.</p>
                </div>
                    ...
                    <div className="rounded-md shadow-sm space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                value={username}
                                disabled
                                className="appearance-none rounded-lg relative block w-full px-3 py-3 border border-gray-600 bg-gray-900 text-gray-400 focus:outline-none sm:text-sm"
                            />
                        </div>
                        <div>
                            <label htmlFor="password-edit" className="block text-sm font-medium text-gray-300 mb-2">New Password</label>
                        ...
                        <div>
                            <label htmlFor="confirm-password-edit" className="block text-sm font-medium text-gray-300 mb-2">Confirm Password</label>
                            <input
                        ...
                        <div>
                            <label htmlFor="role-edit" className="block text-sm font-medium text-gray-300 mb-2">Role</label>
                            <select
                                id="role-edit"
                                name="role"
                                value={role}
