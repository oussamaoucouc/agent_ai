        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
            <div className="bg-slate-900 border border-slate-700 rounded-xl w-full max-w-2xl max-h-[80vh] flex flex-col shadow-2xl relative">
                ...
                <div className="p-4 flex-1 overflow-y-auto">
                    {/* Upload Area */}
                    <div className="mb-4">
                        <label className={`flex flex-col items-center justify-center w-full h-24 border-2 border-slate-600 border-dashed rounded-lg bg-slate-800/50 transition-colors ${uploading ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer hover:bg-slate-800 hover:border-sky-500'}`}>
                            <div className="flex flex-col items-center justify-center py-4">
                                <UploadIcon className="w-6 h-6 mb-2 text-slate-400" />
