...
import { SendIcon, ToolIcon, StopIcon, AgentIcon, DocumentWithTextIcon, PlusIcon, XMarkIcon, ImageIcon, ExcelIcon, DatabaseIcon } from './icons';
                    ...
                    {isLoading && !isPlayingAudio ? (
                        ...
                        <>
                            ...
                            <div className="bg-slate-800/40 border border-slate-600/50 p-0.5 rounded-full flex items-center gap-0.5">
                                ...
                                <div className="relative group flex flex-col items-center">
                                    <button
                                        onClick={() => onQueryModeChange('postgres')}
                                        disabled={isLoading || isRecording}
                                        className={`p-2 rounded-full ${queryMode === 'postgres' ? 'bg-sky-600 hover:bg-sky-500' : 'bg-transparent hover:bg-white/10'} disabled:bg-slate-700 disabled:cursor-not-allowed transition-colors`}
                                        aria-label="Postgres Analyst Mode"
                                        aria-pressed={queryMode === 'postgres'}
                                    >
